          ...
          <CardWrapper title="Contact Info">
            <div className="space-y-8">
              <ContactItem
                icon={<FaEnvelope />}
                title="Email"
                content="rahatshovon.fun@gmail.com"
              />
              <ContactItem
                icon={<FaPhone />}
                title="Phone"
                content="+8801620-554243"
              />
              <ContactItem
                icon={<FaMapMarkerAlt />}
                title="Location"
          ...
          <CardWrapper title="Social Links">
            <div className="space-y-8">
              <SocialItem
                icon={<FaGithub />}
                label="GitHub"
                link="https://github.com/RahatShovon"
              />
              <SocialItem
                icon={<FaLinkedin />}
                label="Linkedin"
                link="https://www.linkedin.com/in/rahat-h-shovon/"
              />
              <SocialItem
                icon={<FaFacebook />}
                label="Facebook"
                link="https://www.facebook.com/rahat.h.shovon/"
              />
            </div>
          </CardWrapper>
