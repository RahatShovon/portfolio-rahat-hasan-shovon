...
export default function PortFooter() {
  ...
  return (
    <div className="min-h-[400px] max-w-[1400px] mx-auto flex items-end justify-center px-4 py-4 sm:px-6  lg:px-0 pb-8 font-sans relative">
      ...
      <motion.footer
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="w-full max-w-[1400px] bg-[#0f0f1a] rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 relative 
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center sm:text-left">
          ...
          >
            <div>
              <h2 className="text-3xl font-extrabold text-white tracking-tight">
                RAHAT <span className="text-purple-500">.</span>
              </h2>
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <nav className="flex flex-col space-y-4">
              <NavLink text="GitHub Repos" link="https://github.com/RahatShovon?tab=repositories" />
          ...
          >
            ...
            <motion.a
              href="mailto:rahatshovon.fun@gmail.com"
