...
import Rahat_img from '../../assets/Rahat.jpg';
...
export default function Hero (){
  const roles = ["Full Stack Developer", "Figma to HTML ", "Database Architecture", "CMS Expert"];
...
<div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-0 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10 overflow-hidden lg:overflow-visible">
  ...
  <motion.div
    ...
    className="order-first md:order-last relative min-h-[400px] lg:h-[600px] flex items-center justify-center lg:justify-end mt-12 lg:mt-0"
  >
    ...
    <div className="relative w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[420px] aspect-[3/4] bg-gray-900 rounded-[2rem] border border-white/10 p-2 shadow-indigo-500/20 rotate-3 hover:rotate-0 transition-all duration-500">
      <div className="w-full h-full bg-zinc-800 rounded-[1.5rem] overflow-hidden relative group">
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black/90 to-transparent">
          <p className="text-white font-bold text-xl">Rahat</p>
