...
const TechStackSection = () => {
  ...
  const backendStack = [
    { name: "Shopify", icon: <SiShopify className="text-[#339933] text-xl" /> },
    { name: "HubSpot", icon: <SiHubspot className="text-[#FF7A59] text-xl" /> },
    { name: "GoHighLevel", icon: <SiMake className="text-[#6D00CC] text-xl" /> },
    { name: "Wordpress", icon: <SiWordpress className="text-[#00749C] text-xl" /> },
    { name: "Wix Studio", icon: <SiWix className="text-[#FFFFF] text-xl" /> },
  ];

  const clientServices = [
    { name: "Full-Stack Web Apps", icon: <Server className="text-[#9C82F5] text-xl" /> },
    { name: "E-commerce Expert", icon: <ShoppingBag className="text-[#9C82F5] text-xl" /> },
