...
export default function Navbar() {
  ...
  const navLinks = ["Services", "Projects", "Contact", "About" ];
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-4 lg:px-0 flex items-center justify-between scroll-smooth ">
        {/* LOGO */}
        <motion.div
        ...
        >
          RAHAT<span className="text-indigo-500">.</span>
        </motion.div>
        ...
        <div className="hidden md:flex items-center gap-6">
          <div className="flex gap-4 border-r border-white/10 pr-6">
            <SocialIcon Icon={Facebook} href={'https://www.facebook.com/rahat.h.shovon/'} />
            <SocialIcon Icon={Linkedin} href="https://www.linkedin.com/in/rahat-h-shovon/" />
            <SocialIcon Icon={Github} href="https://github.com/RahatShovon" />
          </div>
